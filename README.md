...
Microservicio backend encargado de la gestión de despachos del sistema Innovatech Chile.
...
SPRING_DATASOURCE_URL=jdbc:mysql://10.0.2.218:3307/despachos_db
SPRING_DATASOURCE_USERNAME=despachos_user
SPRING_DATASOURCE_PASSWORD=despachos_pass
...
Ejecución local:
docker run -p 8081:8081 back-despachos
...
160661694072.dkr.ecr.us-east-1.amazonaws.com/back-despachos:latest
